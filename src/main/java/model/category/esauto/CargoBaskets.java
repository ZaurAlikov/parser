...
public class CargoBaskets implements Category {
    ...
    public CargoBaskets() {
//        cargoBaskets.add("https://es-auto.ru/cargo-baskets/sku/atlant-8971-138x99-sm-v-sbore/");
//        cargoBaskets.add("https://es-auto.ru/cargo-baskets/sku/atlant-8972-158x99-sm-v-sbore/");
//        cargoBaskets.add("https://es-auto.ru/cargo-baskets/sku/buzz-rack-buzztrekker/");
